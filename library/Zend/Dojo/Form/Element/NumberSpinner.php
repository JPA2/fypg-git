...
class Zend_Dojo_Form_Element_NumberSpinner extends Zend_Dojo_Form_Element_ValidationTextBox
{
    ...
    {
        $this->setDijitProp('defaultTimeout', (int) $timeout);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('defaultTimeout');
    }
    ...
    {
        $this->setDijitProp('timeoutChangeRate', (int) $rate);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('timeoutChangeRate');
    }
    ...
    {
        $this->setDijitProp('largeDelta', (float) $delta);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('largeDelta');
    }
    ...
    {
        $this->setDijitProp('smallDelta', (float) $delta);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('smallDelta');
    }
    ...
    {
        $this->setDijitProp('intermediateChanges', (bool) $flag);
        return $this;
    }
    ...
    public function getIntermediateChanges()
    {
        ...
        return $this->getDijitProp('intermediateChanges');
    }
    ...
    {
        $this->setDijitProp('rangeMessage', (string) $message);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('rangeMessage');
    }
    ...
    public function setMin($value)
    {
        ...
        if ($this->hasDijitParam('constraints')) {
            $constraints = $this->getDijitProp('constraints');
        }
        $constraints['min'] = (float) $value;
        $this->setDijitProp('constraints', $constraints);
        return $this;
    }
