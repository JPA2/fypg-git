...
class Zend_Dojo_Form_Element_Editor extends Zend_Dojo_Form_Element_Dijit
{
    ...
    public function addCaptureEvent($event)
    {
        ...
        $this->setDijitProp('captureEvents', $captureEvents);
        return $this;
    }
    ...
    public function getCaptureEvents()
    {
        ...
        return $this->getDijitProp('captureEvents');
    }
    ...
    public function addEvent($event)
    {
        ...
        $events[] = (string) $event;
        $this->setDijitProp('events', $events);
        return $this;
    }
    ...
    public function getEvents()
    {
        ...
        return $this->getDijitProp('events');
    }
    ...
    public function addPlugin($plugin)
    {
        ...
        $this->setDijitProp('plugins', $plugins);
        return $this;
    }
    ...
    public function getPlugins()
    {
        ...
        return $this->getDijitProp('plugins');
    }
    ...
    {
        return $this->setDijitProp('editActionInterval', (int) $interval);
    }
    ...
    public function getEditActionInterval()
    {
        ...
        return $this->getDijitProp('editActionInterval');
    }
    ...
    {
        return $this->setDijitProp('focusOnLoad', (bool) $flag);
    }
    ...
    public function getFocusOnLoad()
    {
        ...
        return $this->getDijitProp('focusOnLoad');
    }
    ...
    public function setHeight($height)
    {
        ...
        return $this->setDijitProp('height', $height);
    }
    ...
    public function getHeight()
    {
        ...
        return $this->getDijitProp('height');
    }
    ...
    {
        return $this->setDijitProp('inheritWidth', (bool) $flag);
    }
    ...
    public function getInheritWidth()
    {
        ...
        return $this->getDijitProp('inheritWidth');
    }
    ...
    public function setMinHeight($minHeight)
    {
        ...
        return $this->setDijitProp('minHeight', $minHeight);
    }
    ...
    public function getMinHeight()
    {
        ...
        return $this->getDijitProp('minHeight');
    }
    ...
    public function addStyleSheet($styleSheet)
    {
        ...
        return $this->setDijitProp('styleSheets', implode(';', $stylesheets));
    }
    ...
    public function getStyleSheets()
    {
        ...
        return $this->getDijitProp('styleSheets');
    }
    ...
    public function removeStyleSheet($styleSheet)
    {
        ...
        if (false !== ($index = array_search($styleSheet, $styleSheets))) {
            ...
            $this->setDijitProp('styleSheets', implode(';', $styleSheets));
        }
        return $this;
    }
    ...
    {
        return $this->setDijitProp('updateInterval', (int) $interval);
    }
    ...
    public function getUpdateInterval()
    {
        ...
        return $this->getDijitProp('updateInterval');
    }
    ...
    public function addExtraPlugin($plugin)
    {
        ...
        $this->setDijitProp('extraPlugins', $extraPlugins);
        return $this;
    }
    ...
    public function getExtraPlugins()
    {
        ...
        return $this->getDijitProp('extraPlugins');
    }
