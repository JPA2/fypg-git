...
class Zend_Dojo_Form_Element_ComboBox extends Zend_Dojo_Form_Element_DijitMulti
{
    ...
    public function getStoreInfo()
    {
        if (!$this->hasDijitParam('store')) {
            $this->dijitProps['store'] = array();
        }
        return $this->dijitProps['store'];
    }
    ...
    {
        $this->setDijitProp('autocomplete', (bool) $flag);
        return $this;
    }
    ...
    public function getAutocomplete()
    {
        ...
        return $this->getDijitProp('autocomplete');
    }
