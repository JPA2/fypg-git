...
class Zend_Dojo_Form_Element_ValidationTextBox extends Zend_Dojo_Form_Element_TextBox
{
    ...
    {
        $this->setDijitProp('invalidMessage', (string) $message);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('invalidMessage');
    }
    ...
    {
        $this->setDijitProp('promptMessage', (string) $message);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('promptMessage');
    }
    ...
    {
        $this->setDijitProp('regExp', (string) $regexp);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('regExp');
    }
    ...
    public function getConstraint($key)
    {
        ...
        return $this->dijitProps['constraints'][$key];
    }
    ...
    public function getConstraints()
    {
        if ($this->hasDijitParam('constraints')) {
            return $this->getDijitProp('constraints');
        }
        return array();
    }
    ...
    public function removeConstraint($key)
    {
        $key = (string) $key;
        if ($this->hasConstraint($key)) {
            unset($this->dijitProps['constraints'][$key]);
        }
        return $this;
    }
