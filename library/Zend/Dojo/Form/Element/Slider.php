...
abstract class Zend_Dojo_Form_Element_Slider extends Zend_Dojo_Form_Element_Dijit
{
    ...
    {
        $this->setDijitProp('clickSelect', (bool) $flag);
        return $this;
    }
    ...
    public function getClickSelect()
    {
        ...
        return $this->getDijitProp('clickSelect');
    }
    ...
    {
        $this->setDijitProp('showButtons', (bool) $flag);
        return $this;
    }
    ...
    public function getShowButtons()
    {
        ...
        return $this->getDijitProp('showButtons');
    }
    ...
    {
        $this->setDijitProp('discreteValues', (int) $value);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('discreteValues');
    }
    ...
    {
        $this->setDijitProp('maximum', (int) $value);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('maximum');
    }
    ...
    {
        $this->setDijitProp('minimum', (int) $value);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('minimum');
    }
    ...
    {
        $this->setDijitProp('pageIncrement', (int) $value);
        return $this;
    }
    ...
    {
        return $this->getDijitProp('pageIncrement');
    }
}
