...
abstract class Zend_Dojo_Form_Element_Dijit extends Zend_Form_Element
{
    ...
    {
        $this->dijitProps = array_merge($this->dijitProps, $params);
        return $this;
    }
    ...
    {
        return array_key_exists($key, $this->dijitProps);
    }
    ...
    {
        $key = (string) $key;
        if (array_key_exists($key, $this->dijitProps)) {
            unset($this->dijitProps[$key]);
        }
        return $this;
    }
